    ...
    <>
      <section className="py-12">
        <div className="text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            ...
            Organizziamo eventi di <span className="font-semibold text-blue-600">rilevanza locale e nazionale</span>
      ...
      <div className=" px-4 py-12">
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <Card className="border-0 shadow-lg">
              <CardHeader>
                <CardTitle className="text-2xl text-gray-800">Seguici sui nostri social network</CardTitle>
              </CardHeader>
              <CardContent>
                  ...
                  <a href="https://t.me/+j-h3ljrMZV8zZmVk" className="group">
                    <Card className="border-2 border-blue-100 hover:border-blue-300 transition-all duration-300 hover:shadow-lg">
                      <CardContent className="p-6 text-center">
                        ...
                        <p className="text-gray-600 text-sm">Il cuore pulsante della nostra community</p>
                      </CardContent>
                    </Card>
                  </a>
                  ...
                  <a href="https://www.linkedin.com/company/devmarche/" className="group">
                    <Card className="border-2 border-blue-100 hover:border-blue-300 transition-all duration-300 hover:shadow-lg">
                      <CardContent className="p-6 text-center">
                        ...
                        <p className="text-gray-600 text-sm">Tutte le nostre iniziative in tempo reale</p>
                      </CardContent>
                    </Card>
                  </a>
                  ...
                  <a href="https://www.facebook.com/groups/developermarche" className="group">
                    <Card className="border-2 border-blue-100 hover:border-blue-300 transition-all duration-300 hover:shadow-lg">
                      <CardContent className="p-6 text-center">
                        ...
                        <p className="text-gray-600 text-sm">Unisciti al nostro gruppo Facebook</p>
                      </CardContent>
                    </Card>
                  </a>
                </div>
            ...
            <Card className="border-0 shadow-lg bg-gradient-to-r from-purple-500 to-pink-500 text-white">
              <CardContent className="p-8">
                <h2 className="text-3xl font-bold mb-4">Vuoi partecipare come speaker?</h2>
                <p className="text-lg mb-6 text-purple-100">
                  Invia la tua proposta con una nuova issue nel repository DevMarche!
                </p>
            ...
            <section id="sponsor">
              ...
              {/* Platinum */}
              <div className="mb-12">
                <h3 className="text-2xl font-bold text-center mb-8 text-gray-700">PLATINUM</h3>
              ...
              {/* Silver */}
              <div className="mb-12">
                <h3 className="text-2xl font-bold text-center mb-8 text-gray-700">SILVER</h3>
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <Card className="border-2 border-gray-200 bg-gradient-to-br from-gray-50 to-slate-50 hover:shadow-lg transition-shadow">
                    <CardContent className="p-8 text-center">
                      <img
                        ...
                        className="max-h-20 mx-auto mb-4"
                      />
                      <h4 className="font-semibold text-gray-800">LowCode Italia</h4>
                    </CardContent>
                  </Card>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-12">
                <Card className="border-2 border-green-200 bg-gradient-to-br from-green-50 to-emerald-50">
                  <CardContent className="p-6">
                    ...
                    <p className="text-gray-600 mb-4">Diventa sponsor e supporta la community tech delle Marche</p>
                ...
                <Card className="border-2 border-pink-200 bg-gradient-to-br from-pink-50 to-rose-50">
                  <CardContent className="p-6">
                    ...
                    <p className="text-gray-600 mb-4">Supporta la community con una donazione</p>
          ...
          <div className="space-y-8">
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-gray-500 text-center py-8">Nessun evento in arrivo</p>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <NavLink to="/eventi/summer-ai-afternoon" className="block">
                  <div className="border-l-4 border-blue-500 pl-4 hover:bg-blue-50 p-3 rounded-r transition-colors">
                    <h4 className="font-semibold text-gray-800">Summer AI Afternoon</h4>
                ...
                <NavLink to="/eventi/pomeriggio-frontend" className="block">
                  <div className="border-l-4 border-green-500 pl-4 hover:bg-green-50 p-3 rounded-r transition-colors">
                    <h4 className="font-semibold text-gray-800">Pomeriggio Frontend</h4>
                    <p className="text-sm text-gray-600">2 Luglio 2025</p>
                  </div>
                </NavLink>
                <NavLink to="/eventi/gaming-day-2-progettare-e-sviluppare-videogiochi" className="block">
                  <div className="border-l-4 border-purple-500 pl-4 hover:bg-purple-50 p-3 rounded-r transition-colors">
                    <h4 className="font-semibold text-gray-800">Gaming Day 2</h4>
        ...
        <Card className="mt-12 border-0 shadow-lg">
          <CardHeader>
            <CardTitle className="text-2xl text-center">ELENCO DONATORI STAGIONE 2024/25</CardTitle>
            <CardDescription className="text-center">
              Lista in ordine alfabetico dei supporter che hanno fornito il consenso alla pubblicazione
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 text-sm">
              {[
                "Alessandro Attene", "Alessandro D'Angelo", "Alessandro Giorgetti", "Alessio Caldarigi",
                "Andrea Cognini", "Antonio Liccardi", "Carlo Bertini", "Carlo Pagliei",
                "Christian Lillini", "Daniela Bonvini", "Daniele Agosti", "Daniele Scarinci",
                "Danilo Dominici", "Diego Bonura", "Diego Guidi", "Diego Santinelli",
                "Emanuele Bellini", "Fabio Del Bene", "Fabio Organtini", "Fabrizio Monti",
                "Federica Ramazzotti", "Filippo Amaduzzi", "Gianni Bortolo Bossini", "Giordano Contigiani",
                "Giorgio Mandolini", "Giovanni Crudo", "Giulia Leonardi", "Giuliano Latini",
                "Giuseppe Vallesi", "Guido Buldrighini", "Leonardo Montini", "Lorenzo Massacci",
                "Lorenzo Pomili", "Luca Bucari", "Luca Petrini", "Marco Bramucci",
                "Marco Gentilozzi", "Marco Mancinelli", "Massimo Di Giulio", "Matteo Galletti",
                "Matteo Pierangeli", "Mauro Morici", "Mauro Piccotti", "Michele Aponte",
                "Michele Focanti", "Mirco Damiani", "Moreno Gentili", "Nicola Bellagamba",
                "Paolo Compieta", "Riccardo Mancinelli", "Roberto Rossi", "Roberto Sileoni",
                "Samuele Pacioni", "Stefano Ottaviani", "Valerio Narcisi", "William Verdolini"
              ].map((name, index) => (
                <div key={index} className="p-2 bg-gray-50 rounded text-gray-700 hover:bg-gray-100 transition-colors">
                  {name}
                </div>
              ))}
            </div>
